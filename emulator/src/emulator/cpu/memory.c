...
cpuInterr _cpuReadMem16(uint32 adr){
	// TODO: Address translation
	cpu_s.data = busRead(adr)|(busRead(adr+1)<<8);
	return 0;
}
...
cpuInterr _cpuReadMem32(uint32 adr){
	// TODO: Address translation
	cpu_s.data = busRead(adr)|(busRead(adr+1)<<8)|(busRead(adr+2)<<16)|(busRead(adr+3)<<24);
	return 0;
}
...
cpuInterr _cpuWriteMem32(uint32 adr, uint32 data){
	...
	busWrite(adr, (data)&0xFF);
	busWrite(adr+1, (data>>8)&0xFF);
	busWrite(adr+2, (data>>16)&0xFF);
	busWrite(adr+3, (data>>24)&0xFF);
	return 0;
}
...
cpuInterr _cpuPop16(){
	uint32 adr = cpu_s.gregs[GREG_ESP];
	// TODO: Address translation
	uint16 data = busRead(adr)|(busRead(adr+1)<<8);
...
cpuInterr _cpuPop32(){
	uint32 adr = cpu_s.gregs[GREG_ESP];
	// TODO: Address translation
	uint32 data = busRead(adr)|(busRead(adr+1)<<8)|(busRead(adr+2)<<16)|(busRead(adr+3)<<24);
...
cpuInterr _cpuFetch16(){
	uint32 adr = cpu_s.reg_pc;
	// TODO: Address translation
	uint16 code = busRead(adr)|(busRead(adr+1)<<8);
	cpu_s.reg_pc += 2;
	cpu_s.code = code;
	return 0;
}
...
cpuInterr _cpuFetch32(){
	uint32 adr = cpu_s.reg_pc;
	// TODO: Address translation
	uint32 code = busRead(adr)|(busRead(adr+1)<<8)|(busRead(adr+2)<<16)|(busRead(adr+3)<<24);
	cpu_s.reg_pc += 4;
	cpu_s.code = code;
	return 0;
}
